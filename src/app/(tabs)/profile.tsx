...
// Top bar that fades in on scroll: the same soft yellow every top bar
// turns to once its page moves, with a hairline under it. It ends 24.5dp below the title's centre (measured on the
// reference). The fade is spread over 44dp of
// scrolling — a gentle dissolve, yet complete by the time the card slides
// under the title.
const BAR_BG = ACCOUNT_BAR_SCROLLED;
