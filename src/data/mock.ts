...
export const menuItems: MenuItem[] = [
  ...
  /* Cattu Coffee */
  {
    ...
    brandId: "cattu",
    categoryId: "coffee",
    name: "Kopi Susu Cattu",
    description: "Espresso + Susu segar + Gula aren",
    price: 22000,
    isBestSeller: true,
    optionGroups: drinkOptions(22000, "Kopi Susu Cattu"),
  },
  {
    id: "cattu-aren-latte",
    brandId: "cattu",
    categoryId: "coffee",
    name: "Aren Latte",
    description: "Espresso + Susu + Sirup aren",
    price: 26000,
    optionGroups: drinkOptions(26000, "Aren Latte"),
  },
  {
    id: "cattu-americano",
    brandId: "cattu",
    categoryId: "coffee",
    name: "Iced Americano",
    description: "Double shot espresso + Air dingin",
    price: 20000,
    optionGroups: drinkOptions(20000, "Iced Americano"),
  },
  {
    id: "cattu-matcha",
    brandId: "cattu",
    categoryId: "non-coffee",
    name: "Matcha Latte",
    description: "Matcha Jepang + Susu segar",
    price: 27000,
    isBestSeller: true,
    optionGroups: [variant(27000), sweetness("Matcha Latte")],
  },
  {
    id: "cattu-red-velvet",
    brandId: "cattu",
    ...
    description: "Red velvet lembut + Susu",
    price: 25000,
    optionGroups: [variant(25000), sweetness("Red Velvet Latte")],
  },
  {
    id: "cattu-croissant",
    brandId: "cattu",
    ...
    description: "Croissant renyah, mentega premium",
    price: 19000,
    optionGroups: plainOptions(19000),
  },
  {
    id: "cattu-cinnamon",
    brandId: "cattu",
    categoryId: "kue",
    name: "Cinnamon Roll",
    description: "Roti gulung kayu manis + glaze gula",
    price: 21000,
    optionGroups: plainOptions(21000),
  },
  /* Lesung Pipi */
  {
    id: "lesung-hakau",
    ...
    categoryId: "dimsum",
    name: "Hakau Udang",
    description: "3 pcs hakau kulit bening isi udang",
    price: 26000,
    optionGroups: plainOptions(26000),
  },
  {
    id: "lesung-bakpao",
    brandId: "lesung-pipi",
    categoryId: "dimsum",
    name: "Bakpao Ayam Kecap",
    description: "2 pcs bakpao lembut isi ayam kecap",
    price: 18000,
    optionGroups: plainOptions(18000),
  },
  {
    ...
    description: "4 pcs lumpia kulit tahu goreng",
    price: 22000,
    isBestSeller: true,
    optionGroups: plainOptions(22000),
  },
  {
    id: "lesung-bolu-pandan",
    brandId: "lesung-pipi",
    categoryId: "kue",
    name: "Bolu Pandan",
    description: "Bolu pandan lembut, potong besar",
    price: 15000,
    optionGroups: plainOptions(15000),
  },
  {
    id: "lesung-es-teh-leci",
    brandId: "lesung-pipi",
    categoryId: "non-coffee",
    name: "Es Teh Leci",
    description: "Teh melati + buah leci",
    price: 14000,
    optionGroups: [variant(14000), sweetness("Es Teh Leci")],
  },
  /* Ayam Goreng Busari */
  {
    id: "busari-kremes",
    ...
    description: "Ayam goreng + kremes renyah + sambal",
    price: 26000,
    isBestSeller: true,
    optionGroups: plainOptions(26000),
  },
  {
    ...
    description: "Ayam penyet + sambal ijo + lalapan",
    price: 27000,
    optionGroups: plainOptions(27000),
  },
  {
    id: "busari-tahu-tempe",
    brandId: "ayam-busari",
    categoryId: "snack",
    name: "Tahu Tempe Goreng",
    description: "4 potong tahu tempe + sambal kecap",
    price: 10000,
    optionGroups: plainOptions(10000),
  },
  {
    id: "busari-es-teh",
    brandId: "ayam-busari",
    categoryId: "non-coffee",
    name: "Es Teh Manis",
    description: "Teh tubruk + gula, dingin",
    price: 6000,
    optionGroups: [variant(6000), sweetness("Es Teh Manis")],
  },
  {
    id: "busari-es-jeruk",
    brandId: "ayam-busari",
    categoryId: "non-coffee",
    name: "Es Jeruk Peras",
    description: "Jeruk peras segar + es",
    price: 9000,
    optionGroups: [variant(9000), sweetness("Es Jeruk Peras")],
  },
];
